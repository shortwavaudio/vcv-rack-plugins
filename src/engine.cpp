...
void Voice_4_controlChange(Voice_4__ctx_type_0 &_ctx, int control, int value, int channel){
   if(control == 30){
      _ctx.level1 = (0.00787401574803f * int_to_float(value));
   }
   if(control == 31){
      _ctx.level2 = (0.00787401574803f * int_to_float(value));
   }
   if(control == 32){
      _ctx.level3 = (0.00787401574803f * int_to_float(value));
   }
   if(control == 33){
      _ctx.level4 = (0.00787401574803f * int_to_float(value));
   }
   if(control == 34){
      _ctx.pw1 = (0.00787401574803f * int_to_float(value));
   }
   if(control == 35){
      _ctx.pw2 = (0.00787401574803f * int_to_float(value));
   }
   if(control == 36){
      _ctx.pw3 = (0.000787401574803f * int_to_float(value));
   }
   if(control == 37){
      _ctx.pw4 = (0.00787401574803f * int_to_float(value));
   }
   if(control == 38){
      _ctx.lfo_rate = Util_map(int_to_float(value),0.0f,127.f,-0.4f,0.1f);
   }
   if(control == 39){
      _ctx.lfo_shape = (0.0236220472441f * int_to_float(value));
   }
   if(control == 40){
   ...
   if(control == 45){
      _ctx.flt_res = (0.00787401574803f * int_to_float(value));
   }
   if(control == 46){
      _ctx.flt_shape = ((value << 2) / 127);
   }
   if(control == 47){
      _ctx.attack = (0.00787401574803f * int_to_float(value));
   }
   if(control == 48){
      _ctx.decay = (0.00787401574803f * int_to_float(value));
   }
   if(control == 49){
      _ctx.sustain = (0.00787401574803f * int_to_float(value));
   }
   if(control == 50){
      _ctx.release = (0.00787401574803f * int_to_float(value));
   }
}
